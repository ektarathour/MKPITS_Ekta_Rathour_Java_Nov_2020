//Example to create calculator by extending frame
...
public class ExToCreateCalculatorByExtendingFrameClass extends Frame implements
        ActionListener {
        ...
        double pn=0;
        double curno=0;
        ExToCreateCalculatorByExtendingFrameClass() {
...
if(ae.getSource()==b1){
    ...
    public static  void main(String[] args) {
        ExToCreateCalculatorByExtendingFrameClass f = new ExToCreateCalculatorByExtendingFrameClass
        ();
    }
}
