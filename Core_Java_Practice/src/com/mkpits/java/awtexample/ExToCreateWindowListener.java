//Example of create window listener
...
public class ExToCreateWindowListener {
    private Frame mainFrame;
    private Label headerLabel;
    private Label statusLabel;
    private Label controlPanel;
    public ExToCreateWindowListener(){
        prepareGUI();
    }
    public static void main(String[] args){
        ExToCreateWindowListener awtListenerDemo = new ExToCreateWindowListener();
