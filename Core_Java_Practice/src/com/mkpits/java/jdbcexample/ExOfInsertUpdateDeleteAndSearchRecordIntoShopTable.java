//create a swing form
// to insert ,update and delete and search records into shop table.
...
public class ExOfInsertUpdateDeleteAndSearchRecordIntoShopTable extends JFrame{
    JLabel l1,l2,l3,l4,l5;
    JTextField t1,t2,t3,t4;
    JButton  b1,b2,b3,b4;
    Connection con = null;
    Statement stmt = null;
    public ExOfInsertUpdateDeleteAndSearchRecordIntoShopTable(){
    ...
    public static void main(String[] args) {
        ExOfInsertUpdateDeleteAndSearchRecordIntoShopTable st=
                new ExOfInsertUpdateDeleteAndSearchRecordIntoShopTable();
    }
}