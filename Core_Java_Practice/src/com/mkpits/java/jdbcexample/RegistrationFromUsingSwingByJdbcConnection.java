//create registration from with jdbc connection using swing
...
import java.sql.Statement;
 class RegistrationFromUsingSwingByJdbcConnection extends JFrame {
    JRadioButton rb1;
    JRadioButton rb2;
    ButtonGroup bg;
    JCheckBox cb1,cb2;
    JComboBox city;
     RegistrationFromUsingSwingByJdbcConnection() {
...
//t2.setEchoChar('*');
         ...
         b1.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e) {
                 ...
                 try {
                     ...
                     String sql="insert into register(username,pwd,gender,course,city) values('"+un+"','"+p+"','"+g+"','"+course+"','"+city1+"')";
     ...
     {
         RegistrationFromUsingSwingByJdbcConnection f=new RegistrationFromUsingSwingByJdbcConnection();
     }
 }
