//A program of arraylist traversing through list iterator student name using swing
...
public class ExOfArrayListTraversingThroughListIteratorUsingSwing extends JFrame {
    JLabel l1,l2;
    JTextField t1,t2;
    JTextArea ta;
    ...
    public ExOfArrayListTraversingThroughListIteratorUsingSwing() {
    ...
    public static void main(String[] args) {
        ExOfArrayListTraversingThroughListIteratorUsingSwing arl=
                new ExOfArrayListTraversingThroughListIteratorUsingSwing();
    }
}
