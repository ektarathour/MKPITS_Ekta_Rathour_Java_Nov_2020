//A program of arraylist collection of student name sorting using swing
...
public class ExOfArrayListSortingInSwing extends JFrame {
    JLabel l1,l2;
    JTextField t1,t2;
    JTextArea ta;
    JButton  b1,b2,b3,b4,b5;
    ArrayList<String> student=new ArrayList<String>();
    public ExOfArrayListSortingInSwing(){
...
add(b1);
    ...
    public static void main(String[] args) {
        ExOfArrayListSortingInSwing arl=new ExOfArrayListSortingInSwing();
    }
}