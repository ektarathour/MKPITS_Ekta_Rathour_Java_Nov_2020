//create a program that generates random numbers using the ThreadLocalRandom class
package com.mkpits.java.generaterandomnumber;

import java.util.concurrent.ThreadLocalRandom;

public class ExOfGenerateRandomNOUsingThreadLocalRandomClass {
